    ...
    return chatUser ? (
      <div className="Chat-bar">
        <div className="Chat-user">
          <img src={chatUser.userData.avatar ? chatUser.userData.avatar : assets.photo1.png} alt="" />
          <p>{chatUser ? chatUser.userData.name : "shona"} {Date.now() - chatUser.userData.lastSeen <= 70000 ? <img className='dot' src={assets.bluedot_icon} alt='' /> : null}</p>
